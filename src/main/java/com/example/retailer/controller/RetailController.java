...
public class RetailController {
    ...
    public RetailController(TransactionService transactionService) {
        this.transactionService = transactionService;
    }

    @GetMapping(REWARD_POINTS)
    public ResponseEntity<ResponseDto> getRewardPointsByQuarter() {
        List<CustomerReward> customerRewards = transactionService.getRewardPointsByQuarter();
        return RetailResponse.successResponse(customerRewards);
    }
}
